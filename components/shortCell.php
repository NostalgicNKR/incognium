...
<div class="btn-group mb-3" role="group" aria-label="Basic example">
  <button type="button" class="button button-primary button-shadow" onclick="copyIt()">Copy</button>
  <button type="button" class="button btn-primary button-shadow" onclick="downloadQR('<?= $qrURL ?>')">Download</button>
</div>
