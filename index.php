...
<head>
    ...
    <meta name="description" content="Redirect anonymously to any sire">
    <meta name="keywords" content="Redirect, free, qr generator, incognium">
    <meta name="author" content="Incognium">
    <meta name="viewport" content="width=device-width, initial-scale=1">
  	<link rel="icon" type="image/x-icon" href="favicon.ico">
    <title>Incognium - Redirect Anonymously</title>
...
<body class="is-boxed has-animations">
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <img width="70" src="dist/img/inco.png">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Redirect Anonymously</h1>
                        <p class="hero-paragraph is-revealing">Create Anonymous links and share the link or use QR code to scan and redirect anonymously.</p>
				
						<?php include_once("components/shortCell.php"); ?>
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                       <img class="mt-3" width="45" src="https://img.icons8.com/wired/64/767de1/add-link.png"/>
                                    </div>
                                    <h3 class="feature-title mt-4">Shorten Link</h3>
                                    <p class="text-sm">Easily short your long link into short link to share easily.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img class="mt-3" width="45" src="https://img.icons8.com/ios/50/4d8ef7/internet--v1.png"/>
                                    </div>
                                    <h3 class="feature-title mt-4">Hide Referrer</h3>
                                    <p class="text-sm">Keep your information secret when you are visiting a external website.</p>
                                </div>
                            </div>
                        </div>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img class="mt-3" width="40" src="https://img.icons8.com/pastel-glyph/64/ff6d8b/qr-code--v2.png"/>

                                    </div>
                                    <h3 class="feature-title mt-4">QR Code</h3>
                                    <p class="text-sm">Use our QR code to easily share your link in media platforms.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img class="mt-3" width="45" src="https://img.icons8.com/wired/64/39d8c8/private2.png"/>
                                    </div>
                                    <h3 class="feature-title mt-4">No Trackers</h3>
                                    <p class="text-sm">There are no trackers or loggers around you to track. You are safe. .</p>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	function submitInput() {
      ...
      if(longURL.includes("incognium")) {
        alert("Cannot generate QR for our links");
      } else {
		window.location.href = "?url="+document.getElementById("urlinput").value;
      }
	}
	function copyIt() {
